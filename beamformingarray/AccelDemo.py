...
from Accelerometer import BNO08x_RVC
vert = """
// Uniforms
// ------------------------------------
...
class Canvas(app.Canvas):
    ...
    def __init__(self):
        ...
        self.projection = perspective(1.0, self.size[0] /
    ...
    def on_timer(self, event):
        self.theta =self.accel.heading[0]
        # print(self.phi)
        self.phi =self.accel.heading[1]
